    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'שלבי הכתיבה לרבי: א. נטילת ידיים והכנה רוחנית. ב. קבלת החלטה טובה — "כלי" לברכה. ג. כתיבת המכתב בלשון חופשית עם שם עברי ושם האם. ד. שליחה — המכתב מודפס ומונח באוהל הקדוש.',
          },
        },
        {
          '@type': 'Question',
