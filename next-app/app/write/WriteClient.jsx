...
const LETTER_STEPS = [
  ...
  { title: 'נתינת צדקה לפני הכתיבה', body: 'נוהגים לתת צדקה לפני כתיבה לרבי — מטבע, תרומה, או כל מעשה נתינה. הצדקה פותחת שערים לקבלת הברכה.' },
  ...
  { title: <>כתבו <em style={{ fontStyle: 'normal', color: 'var(--oh-gold-letter)' }}>בלשונכם שלכם</em></>, body: 'אין נוסח נכון ואין מילים נכונות. כתבו מה שבאמת על הלב — בקשה, תודה, שאלה, שיתוף. הרבי קורא כל מילה.' },
...
const PAN_STEPS = [
  ...
  { title: 'נתינת צדקה לפני הכתיבה', body: 'נוהגים לתת צדקה לפני כתיבת הפ"נ — מטבע, תרומה, או כל מעשה נתינה. הצדקה פותחת שערים לקבלת הברכה.' },
