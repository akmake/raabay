...
const LETTER_STEPS = [
  ...
  { title: 'נתינת צדקה לפני הכתיבה', body: 'מנהג ישראל לתת צדקה לפני כתיבה לרבי — מטבע, תרומה, או כל מעשה נתינה. הצדקה פותחת שערים  לקבלת ברכה.' },
...
const PAN_STEPS = [
  ...
  { title: 'נתינת צדקה לפני הכתיבה', body: 'מנהג ישראל לתת צדקה לפני כתיבת פ"נ — מטבע, תרומה, או כל מעשה נתינה. הצדקה פותחת שערים  לקבלת ברכה.' },
