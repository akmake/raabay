      ...
      {!prepGone && (
        <div
          style={{
            ...
            background: `radial-gradient(60% 50% at 50% 32%, rgba(201,168,92,.16), transparent 70%),
              radial-gradient(100% 100% at 50% 50%, var(--oh-night-2), var(--oh-night) 80%)`,
            padding: 32,
        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 2, width: '100%', maxWidth: 560, textAlign: 'center', color: 'var(--oh-paper-warm)' }}>
            <Candle />
